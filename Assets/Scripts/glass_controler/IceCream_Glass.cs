...
/// </summary>
public class IceCream_Glass : MonoBehaviour
{
    ...
    {
        if (col.gameObject.tag == "IceCream")
        {
            ...
            col.gameObject.tag = "InGlassIceCream";
        ...
        else if (!col.gameObject.CompareTag("cursor") && !col.gameObject.CompareTag("InGlassIceCream") && !col.gameObject.CompareTag("GlassParent") && !col.gameObject.CompareTag("IceCreamGlass") && !col.gameObject.CompareTag("MainCamera"))
        {
