...
/// </summary>
public class Cream_Glass : MonoBehaviour
{
    ...
    void OnTriggerEnter2D(Collider2D col)
    {
        if (col.gameObject.tag == "Cream")
        {
            ...
            col.gameObject.tag = "InGlassCream";
        ...
        else if (!col.gameObject.CompareTag("cursor") && !col.gameObject.CompareTag("InGlassCream") && !col.gameObject.CompareTag("GlassParent") && !col.gameObject.CompareTag("CreamGlass") && !col.gameObject.CompareTag("MainCamera"))
        {
