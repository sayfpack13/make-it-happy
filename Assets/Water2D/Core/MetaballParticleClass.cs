        ...
        if (true)
        {
            ...
            if (i > 0)
            {
                ...
                for (int j = 0; j < Contacts.Length; j++)
                {
                    ...
                    if (Contacts[j].tag != "Water" || Contacts[j].tag != "Cream" || Contacts[j].tag != "IceCream" || Contacts[j].tag != "InGlassWater" || Contacts[j].tag != "InGlassCream" || Contacts[j].tag != "InGlassIceCream")
                        continue;
    ...
    void Blend2()
    {
        if (true)
        {
            ...
            for (int i = 0; i < Water2D.MultiColorManager.instance._allparticles.Length; i++)
            {
                ...
                if (Water2D.MultiColorManager.instance._allparticles[i].gameObject.tag != "Metaball_liquid" || Water2D.MultiColorManager.instance._allparticles[i].gameObject.tag != "Water" || Water2D.MultiColorManager.instance._allparticles[i].gameObject.tag != "Cream" || Water2D.MultiColorManager.instance._allparticles[i].gameObject.tag != "IceCream" || Water2D.MultiColorManager.instance._allparticles[i].gameObject.tag != "InGlassWater" || Water2D.MultiColorManager.instance._allparticles[i].gameObject.tag != "InGlassCream" || Water2D.MultiColorManager.instance._allparticles[i].gameObject.tag != "InGlassIceCream")
                    continue;
